...
def unique_houses(filename):
    ...
    # Code goes here
    read_file = open("cohort_data.txt")
...
def sort_by_cohort(filename):
    ...
    for line in read_file:
        ...
        name = line_list[0] + ' ' + line_list[1] #prints properly
        #print line_list
        if line_list[4] == 'G': #ghost list creation
            #print 'gets to line 55'
            ghosts.append(name)
            #print 'gets to end of ghosts'
        elif line_list[4] == 'Winter 2016': #create 2016 cohort list
            winter_16.append(name)
        elif line_list[4] == 'Spring 2016':
            spring_16.append(name)
        elif line_list[4] == 'Summer 2016': #create 2016 cohort list
...
def all_students_tuple_list(filename):
    ...
    for line in read_file:
        ...
        advisor = line_list[3]
        cohort = line_list[4]
        if len(line_list[4]) > 1: #checking students
